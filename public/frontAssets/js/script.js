    ...
    if ($(".counter-start").length>0) {
        $(".counter-start").each(function() {
            ...
            $(window).scroll(function() {
                if($(window).scrollTop() > (offset - 600) && !(stat_item.hasClass('counting'))) {
...
// Slick.js   
    ...
    $('.client_slick').slick({
        ...
        dots: false,
        arrows: true,
        nextArrow: '<span class="slick_right"><i class="fa fa-caret-right"></i></span>',
        prevArrow: '<span class="slick_left"><i class="fa fa-caret-left"></i></span>',
        responsive: [
          {
            breakpoint: 1200,
            settings: {
